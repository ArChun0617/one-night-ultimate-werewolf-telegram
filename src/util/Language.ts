...
export class Language {
  ...
  constructor(_culture: string = "zhHK") {
    ...
    this.en["ROLE_WAKE_UP_TROUBLEMAKER"] = "你可以揀兩個玩家嘅牌黎對調, 揀多一次同一個人可以重新選擇";
    ...
    this.zhHK["ROLE_WAKE_UP_TROUBLEMAKER"] = "你可以揀兩個玩家嘅牌黎對調, 揀多一次同一個人可以重新選擇";
    ...
    this.zhHK["ASK_NEW_GAME"] = `${Emoji.get('bomb')}  未有人開局喎, 你可以用 \/newgame 黎開一局新嘅`;
    ...
    this.zhHK["ROLE_ACTION_INSOMNIAC"] = "最後既身份係";
